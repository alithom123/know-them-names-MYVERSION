...
$(function () {
  ...
  $(".searchButton").on("click", function () {
    ...
    var url = "https://en.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&generator=search&gsrsearch=" + queryEncoded + "&gsrlimit=1&origin=*";
    ...
    $.getJSON(
      ...
      url,
      function (data) {
        console.log("Wikipedia returned:");
        var page = Object.keys(data.query.pages)[0];
        // Object.keys(obj)[0];
        $("#wiki").html(data.query.pages[page].extract);
        console.log(data);
      }
    );
